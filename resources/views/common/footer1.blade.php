        ...
        <a name="footer"></a>
            ...
            <footer class="c-content-box c-bg-white">
                <div class="container" >
                    ...
                    <div class="col-md-8">
                    <div class="row">   
                        <div class="c-image c-overlay-object" data-height="height" style=" border-top: 1px solid #c9caca;height: 100px;border-bottom: 1px solid #c9caca;padding-top: 60px;font-size: 14px;font-weight: bold;"><a href="{{route('certify')}}">基金管理人登记证明</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://gs.amac.org.cn/">指导机构：中国证券投资基金业协会</a></div> 
                    ...
                    <div class="row"> 
                        ...
                        <div style="height: 175px;padding:20px;border-left: 1px solid #c9caca;">  
                            ...
                            <div class="col-sm-4"> 
                            <div class="row">  
                              <div class="c-image c-overlay-object" data-height="height" style="background-image: url(http://www.ccpofund.com/img/weixin.png);background-repeat : no-repeat;height: 138px;"></div>
                            </div> 
                            </div> 
                        </div>
                        </div>
